...
def tenant_month_spend(session: Session, tenant_id: uuid.UUID, *, since: datetime) -> Decimal:
    """Суммарный расход тенанта из ai_usage с момента since (обычно начало месяца UTC)."""
