...
title: Рыночный и технический ресёрч
description: Конкурентный ландшафт (мониторинг vs SEO-автопилоты), white space, бенчмарки цен и выводы по ingestion/AI/SaaS-стеку; данные живого веб-поиска, июнь 2026.
tags: [market, competitors, pricing]
...
Буквальный конвейер «следить за новостями → понять, важна ли новость **именно этой аудитории** → написать черновик, органично связывающий инфоповод с брендом и упакованный под AEO → дать на ревью в дашборде» **не упакован ни одним крупным горизонтальным игроком**.
...
2. **Симбиоз инфоповода с брендом** (не просто «brand voice», а органичное сплавление свежей новости с позиционированием и экспертизой бренда: «вот эта новость → вот так она работает на твой бренд»). Для LOOTON это прямо коммерческий потенциал из её «Критериев».
...
**Вывод по цене:** гравитация категории — **~$99/мес за один бренд на автопилоте**. Можем стоять чуть выше keyword-пака за счёт релевантности + AEO, но ниже $295+ AEO-генераторов. Маржа и липкость живут в агентском мульти-бренд тарифе. Детали — в [06_pricing_unit_economics.md](/06_pricing_unit_economics.md).
...
Все адаптеры (RSS, Crawl4AI-скрапер, Telegram, Reddit) отдают единый **canonical Document** (поля — в [03_architecture.md](/03_architecture.md)).
...
**Скоринг практически бесплатен, драфтинг — реальный COGS.** Клиент со скорингом 10k статей + 200 черновиков/мес на Sonnet ≈ **$10/мес AI-затрат**; на GPT-mini ≈ $3.5/мес. Закладываем +30–50% буфер на ретраи/few-shot. Детали — в [06_pricing_unit_economics.md](/06_pricing_unit_economics.md).
...
Подробное обоснование — в [03_architecture.md](/03_architecture.md). Сводка решений:
