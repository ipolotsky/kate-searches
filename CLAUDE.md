...
Полный decision log и навигация по bundle — в таблице ниже (`docs/` — OKF-совместимый knowledge bundle v0.1, см. [docs/index.md](docs/index.md)).

| Документ                            | Что внутри                                                |
| ----------------------------------- | --------------------------------------------------------- |
| `docs/00_README.md`                 | Обзор, decision log, навигация по bundle                  |
| `docs/01_market_research.md`        | Конкуренты, white space, бенчмарки цен                    |
| `docs/02_PRD.md`                    | Продукт: проблема, ICP, JTBD, позиционирование, метрики   |
| `docs/03_architecture.md`           | Архитектура: стек, схема данных, адаптеры, AI-пайплайн    |
| `docs/04_mvp_spec.md`               | MVP-скоуп, user stories, экраны, acceptance, вехи         |
| `docs/05_ai_pipeline_prompts.md`    | Промпт-спеки: extract→score→generate, JSON-схемы, SEO/AEO |
| `docs/06_pricing_unit_economics.md` | Экономика: COGS, тарифная сетка, точка прибыльности       |
| `docs/07_m1_ingestion_plan.md`      | План вехи M1: адаптеры, Celery, дедуп, задачи T1–T15      |
| `docs/08_deployment.md`             | Деплой/инфра: CI/CD, VM, Traefik, секреты                 |
| `docs/09_launch_plan.md`            | План запуска: триал, Stripe, Resend, launch-blockers      |
| `docs/HANDOFF.md`                   | Актуальный снимок состояния и инженерный лог M0–M6.4      |
| `docs/ui/UI_UX_Requirements.md`     | Внутренний UI/UX-стандарт (WCAG, эвристики, мобильный UX) |
