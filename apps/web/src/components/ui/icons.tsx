// Минимальный набор инлайн-SVG иконок (heroicons-стиль), чтобы не тянуть react-icons.
// Каждая принимает SVGProps и наследует className/размер от вызывающего.
...
export const UsageIcon: React.FC<IconProps> = (props) => (
  <svg {...base(props)}>
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
